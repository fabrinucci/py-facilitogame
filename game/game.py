...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode( (WIDTH, HEIGTH) )
    ...
    def draw_text(self):
        self.display_text(self.score_format(), TEXT_SIZE, BLACK, WIDTH // 2, TEXT_POS_Y)
        self.display_text(self.level_format(), TEXT_SIZE, BLACK, 60, TEXT_POS_Y)

        if not self.playing:
            self.display_text('You Lost :(', TEXT_LOSE, BLACK, WIDTH // 2, HEIGTH // 2)
            self.display_text('Press r to reset game', TEXT_RESET, BLACK, WIDTH // 2, 50)
    ...
    def menu(self):
        ...
        self.display_text('Press any key to start', TEXT_RESET, BLACK, WIDTH // 2, 10)
